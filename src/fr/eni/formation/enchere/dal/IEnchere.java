...
public interface IEnchere {
	...
	public void deleteEnchere(Enchere enchere, ArticleVendu articleVendu, Utilisateur u)
			throws BLLException, DALException;

	public void updateEnchere(Enchere enchere, ArticleVendu articleVendu, Utilisateur u)
			throws BLLException, DALException;
